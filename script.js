...
const loadModel = async () => {
    try {
        const tfliteModel = await tflite.loadTFLiteModel(
            // "https://storage.googleapis.com/food-vision-model-food-or-not-food/food_not_food_model_v1.tflite"
            // https://storage.googleapis.com/food-vision-model-food-or-not-food/food_not_food_model_v3.tflite
